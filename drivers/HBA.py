...
#
# HBA: Hardware HBA LUN driver, e.g. Fibre Channel or SAS or
# hardware based iSCSI
#

import LUNperVDI
import devscan, scsiutil, util
...
class HBA():
    ...
    def scan(self, sr_uuid):
        ...
        return super(HBA, self).scan(sr_uuid)
